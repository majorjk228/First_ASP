...
{
    public class OldAppDbContent : DbContext
    {
        ...
        public OldAppDbContent(DbContextOptions<OldAppDbContent> options) : base(options) // Для взаимодействия с базой данных через Entity Framework Core
